        ...
        <div className="recordcountpanel">
          <div>
            <Button color="primary" sx={{ borderRadius: 50 }}>
              ...
              <div style={{ fontSize: 20, paddingLeft: 2 }}>物流公司: {t1}</div>
            </Button>
          </div>
          <div>
            <Button color="primary" sx={{ borderRadius: 50 }}>
              <Face4RoundedIcon />
              <div style={{ fontSize: 20, paddingLeft: 2 }}>客户信息: {t2}</div>
            </Button>
          </div>
          <div>
            <Button color="primary" sx={{ borderRadius: 50 }}>
              <CategoryRoundedIcon />
              <div style={{ fontSize: 20, paddingLeft: 2 }}>物流信息: {t3}</div>
            </Button>
          </div>
          <div>
            <Button color="primary" sx={{ borderRadius: 50 }}>
              <WidgetsRoundedIcon />
              <div style={{ fontSize: 20, paddingLeft: 2 }}>
                集装箱动态: {t4}
              </div>
            </Button>
          </div>
          <div>
            <Button color="primary" sx={{ borderRadius: 50 }}>
              ...
              <div style={{ fontSize: 20, paddingLeft: 2 }}>装货表: {t5}</div>
            </Button>
          </div>
          <div>
            <Button color="primary" sx={{ borderRadius: 50 }}>
              <ArchiveRoundedIcon />
              <div style={{ fontSize: 20, paddingLeft: 2 }}>卸货表: {t6}</div>
            </Button>
          </div>
          <div>
            <Button
            ...
            >
              ...
              <div style={{ fontSize: 20, paddingLeft: 2 }}>刷新</div>
            </Button>
          </div>
        </div>
      </ThemeProvider>
